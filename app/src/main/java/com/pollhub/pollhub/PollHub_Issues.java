...
public class PollHub_Issues extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poll_hub__issues);
    ...
    private void parseList() {
        ...
        for(int i = 0; i < pollData.size(); i++){
            ...
            if (p.title.contains("healthcare") || p.title.contains("finance") || p.title.contains("economy") || p.title.contains("process") || p.title.contains("policy") || p.title.contains("military") || p.title.contains("defense")) {
        ...
        list.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> arg0, View view,
                        ...
                        Intent i = new Intent(PollHub_Issues.this,Poll_Activity.class);
